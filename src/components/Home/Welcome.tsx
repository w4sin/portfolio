...
const Welcome = () => {
    ...
    return (
        <div id={"Home"} style={{ backgroundImage: 'linear-gradient(rgba(255,255,255,0.6), rgba(255,255,255,0.6)), url("https://picsum.photos/1920/1080")' }}
            ...
            <div className={"w-9/12 h-4/6 mt-16 flex justify-center items-center border border-slate-900"}>
                <div ref={refView} className={"flex flex-col items-center transition ease-in-out duration-[1500ms] " + animFromBot(isVisible)}>
                    <h2 className="text-4xl md:text-5xl px-2 text-center font-bold block sm:inline-block">{"Welcome to "}<span className="block sm:inline-block mt-2 sm:mt-0">{"My Portfolio"}</span></h2>
